...
var l=e.element[0];i(l).not(l).map(function(){return a(this).button("widget")[0]}).removeClass("ui-state-active").attr("aria-pressed","false")});else{this.buttonElement.bind("mousedown.button",function(){if(h.disabled)return false;a(this).addClass("ui-state-active");b=this;a(document).one("mouseup",function(){b=null})}).bind("mouseup.button",function(){if(h.disabled)return false;a(this).removeClass("ui-state-active")}).bind("keydown.button",function(l){if(h.disabled)return false;if(l.keyCode==a.ui.keyCode.SPACE||
...
this.element[j.collapsible?"addClass":"removeClass"]("ui-tabs-collapsible");j.cookie&&this._cookie(j.selected,j.cookie);i=0;for(var l;l=this.lis[i];i++)a(l)[a.inArray(i,j.disabled)!=-1&&!a(l).hasClass("ui-tabs-selected")?"addClass":"removeClass"]("ui-state-disabled");j.cache===false&&this.anchors.removeData("cache.tabs");this.lis.add(this.anchors).unbind(".tabs");if(j.event!=="mouseover"){var n=function(m,p){p.is(":not(.ui-state-disabled)")&&p.addClass("ui-state-"+m)},s=function(m,p){p.removeClass("ui-state-"+
m)};this.lis.bind("mouseover.tabs",function(){n("hover",a(this))});this.lis.bind("mouseout.tabs",function(){s("hover",a(this))});this.anchors.bind("focus.tabs",function(){n("focus",a(this).closest("li"))});this.anchors.bind("blur.tabs",function(){s("focus",a(this).closest("li"))})}var r,v;if(j.fx)if(a.isArray(j.fx)){r=j.fx[0];v=j.fx[1]}else r=v=j.fx;var o=v?function(m,p){a(m).closest("li").addClass("ui-tabs-selected ui-state-active");p.hide().removeClass("ui-tabs-hide").animate(v,v.duration||"normal",
function(){e(p,v);h._trigger("show",null,h._ui(m,p[0]))})}:function(m,p){a(m).closest("li").addClass("ui-tabs-selected ui-state-active");p.removeClass("ui-tabs-hide");h._trigger("show",null,h._ui(m,p[0]))},q=r?function(m,p){p.animate(r,r.duration||"normal",function(){h.lis.removeClass("ui-tabs-selected ui-state-active");p.addClass("ui-tabs-hide");e(p,r);h.element.dequeue("tabs")})}:function(m,p){h.lis.removeClass("ui-tabs-selected ui-state-active");p.addClass("ui-tabs-hide");h.element.dequeue("tabs")};
this.anchors.bind(j.event+".tabs",function(){var m=this,p=a(m).closest("li"),u=h.panels.filter(":not(.ui-tabs-hide)"),x=h.element.find(h._sanitizeSelector(m.hash));if(p.hasClass("ui-tabs-selected")&&!j.collapsible||p.hasClass("ui-state-disabled")||p.hasClass("ui-state-processing")||h.panels.filter(":animated").length||h._trigger("select",null,h._ui(this,x[0]))===false){this.blur();return false}j.selected=h.anchors.index(this);h.abort();if(j.collapsible)if(p.hasClass("ui-tabs-selected")){j.selected=
-1;j.cookie&&h._cookie(j.selected,j.cookie);h.element.queue("tabs",function(){q(m,u)}).dequeue("tabs");this.blur();return false}else if(!u.length){j.cookie&&h._cookie(j.selected,j.cookie);h.element.queue("tabs",function(){o(m,x)});h.load(h.anchors.index(this));this.blur();return false}j.cookie&&h._cookie(j.selected,j.cookie);if(x.length){u.length&&h.element.queue("tabs",function(){q(m,u)});h.element.queue("tabs",function(){o(m,x)});h.load(h.anchors.index(this))}else throw"jQuery UI Tabs: Mismatching fragment identifier.";
...
if(h.hasClass("ui-tabs-selected")&&this.anchors.length>1)this.select(i+(i+1<this.anchors.length?1:-1));e.disabled=a.map(a.grep(e.disabled,function(k){return k!=i}),function(k){return k>=i?--k:k});this._tabify();this._trigger("remove",null,this._ui(h.find("a")[0],j[0]));return this},enable:function(i){i=this._getIndex(i);var e=this.options;if(a.inArray(i,e.disabled)!=-1){this.lis.eq(i).removeClass("ui-state-disabled");e.disabled=a.grep(e.disabled,function(h){return h!=i});this._trigger("enable",null,
this._ui(this.anchors[i],this.panels[i]));return this}},disable:function(i){i=this._getIndex(i);var e=this.options;if(i!=e.selected){this.lis.eq(i).addClass("ui-state-disabled");e.disabled.push(i);e.disabled.sort();this._trigger("disable",null,this._ui(this.anchors[i],this.panels[i]))}return this},select:function(i){i=this._getIndex(i);if(i==-1)if(this.options.collapsible&&this.options.selected!=-1)i=this.options.selected;else return this;this.anchors.eq(i).trigger(this.options.event+".tabs");return this},
load:function(i){i=this._getIndex(i);var e=this,h=this.options,j=this.anchors.eq(i)[0],k=a.data(j,"load.tabs");this.abort();if(!k||this.element.queue("tabs").length!==0&&a.data(j,"cache.tabs"))this.element.dequeue("tabs");else{this.lis.eq(i).addClass("ui-state-processing");if(h.spinner){var l=a("span",j);l.data("label.tabs",l.html()).html(h.spinner)}this.xhr=a.ajax(a.extend({},h.ajaxOptions,{url:k,success:function(n,s){e.element.find(e._sanitizeSelector(j.hash)).html(n);e._cleanup();h.cache&&a.data(j,
...
nw:".ui-resizable-nw"});if(this.handles.constructor==String){if(this.handles=="all")this.handles="n,e,s,w,se,sw,ne,nw";var g=this.handles.split(",");this.handles={};for(var i=0;i<g.length;i++){var e=a.trim(g[i]),h=a('<div class="ui-resizable-handle '+("ui-resizable-"+e)+'"></div>');/sw|se|ne|nw/.test(e)&&h.css({zIndex:++f.zIndex});"se"==e&&h.addClass("ui-icon ui-icon-gripsmall-diagonal-se");this.handles[e]=".ui-resizable-"+e;this.element.append(h)}}this._renderAxis=function(j){j=j||this.element;for(var k in this.handles){if(this.handles[k].constructor==
...
var d=function(g){a(g).removeClass("ui-resizable ui-resizable-disabled ui-resizable-resizing").removeData("resizable").unbind(".resizable").find(".ui-resizable-handle").remove()};if(this.elementIsWrapper){d(this.element);var f=this.element;f.after(this.originalElement.css({position:f.css("position"),width:f.outerWidth(),height:f.outerHeight(),top:f.css("top"),left:f.css("left")})).remove()}this.originalElement.css("resize",this.originalResizeStyle);d(this.originalElement);return this},_mouseCapture:function(d){var f=
false;for(var g in this.handles)if(a(this.handles[g])[0]==d.target)f=true;return!this.options.disabled&&f},_mouseStart:function(d){var f=this.options,g=this.element.position(),i=this.element;this.resizing=true;this.documentScroll={top:a(document).scrollTop(),left:a(document).scrollLeft()};if(i.is(".ui-draggable")||/absolute/.test(i.css("position")))i.css({position:"absolute",top:g.top,left:g.left});a.browser.opera&&/relative/.test(i.css("position"))&&i.css({position:"relative",top:"auto",left:"auto"});
...
0,maxHeight:c(f.maxHeight)?f.maxHeight:Infinity};if(this._aspectRatio||d){d=f.minHeight*this.aspectRatio;i=f.minWidth/this.aspectRatio;g=f.maxHeight*this.aspectRatio;e=f.maxWidth/this.aspectRatio;if(d>f.minWidth)f.minWidth=d;if(i>f.minHeight)f.minHeight=i;if(g<f.maxWidth)f.maxWidth=g;if(e<f.maxHeight)f.maxHeight=e}this._vBoundaries=f},_updateCache:function(d){this.offset=this.helper.offset();if(c(d.left))this.position.left=d.left;if(c(d.top))this.position.top=d.top;if(c(d.height))this.size.height=
...
e.top||0,left:g.position.left-e.left||0},j=function(k,l){a(k).each(function(){var n=a(this),s=a(this).data("resizable-alsoresize"),r={},v=l&&l.length?l:n.parents(f.originalElement[0]).length?["width","height"]:["width","height","top","left"];a.each(v,function(o,q){if((o=(s[q]||0)+(h[q]||0))&&o>=0)r[q]=o||null});if(a.browser.opera&&/relative/.test(n.css("position"))){g._revertToRelativePosition=true;n.css({position:"absolute",top:"auto",left:"auto"})}n.css(r)})};typeof d.alsoResize=="object"&&!d.alsoResize.nodeType?
a.each(d.alsoResize,function(k,l){j(k,l)}):j(d.alsoResize)},stop:function(){var d=a(this).data("resizable"),f=d.options,g=function(i){a(i).each(function(){var e=a(this);e.css({position:e.data("resizable-alsoresize").position})})};if(d._revertToRelativePosition){d._revertToRelativePosition=false;typeof f.alsoResize=="object"&&!f.alsoResize.nodeType?a.each(f.alsoResize,function(i){g(i)}):g(f.alsoResize)}a(this).removeData("resizable-alsoresize")}});a.ui.plugin.add("resizable","animate",{stop:function(d){var f=
...
var h=d.containerSize.height,j=d.containerSize.width;j=a.ui.hasScroll(f,"left")?f.scrollWidth:j;h=a.ui.hasScroll(f)?f.scrollHeight:h;d.parentData={element:f,left:g.left,top:g.top,width:j,height:h}}}},resize:function(d){var f=a(this).data("resizable"),g=f.options,i=f.containerOffset,e=f.position;d=f._aspectRatio||d.shiftKey;var h={top:0,left:0},j=f.containerElement;if(j[0]!=document&&/static/.test(j.css("position")))h=i;if(e.left<(f._helper?i.left:0)){f.size.width+=f._helper?f.position.left-i.left:
...
i.top)+f.sizeDiff.height);e=f.containerElement.get(0)==f.element.parent().get(0);h=/relative|absolute/.test(f.containerElement.css("position"));if(e&&h)g-=f.parentData.left;if(g+f.size.width>=f.parentData.width){f.size.width=f.parentData.width-g;if(d)f.size.height=f.size.width/f.aspectRatio}if(i+f.size.height>=f.parentData.height){f.size.height=f.parentData.height-i;if(d)f.size.width=f.size.height*f.aspectRatio}},stop:function(){var d=a(this).data("resizable"),f=d.options,g=d.containerOffset,i=d.containerPosition,
...
a(this).data("resizable"),f=d.options,g=d.size,i=d.originalSize,e=d.originalPosition,h=d.axis;f.grid=typeof f.grid=="number"?[f.grid,f.grid]:f.grid;var j=Math.round((g.width-i.width)/(f.grid[0]||1))*(f.grid[0]||1);f=Math.round((g.height-i.height)/(f.grid[1]||1))*(f.grid[1]||1);if(/^(se|s|e)$/.test(h)){d.size.width=i.width+j;d.size.height=i.height+f}else if(/^(ne)$/.test(h)){d.size.width=i.width+j;d.size.height=i.height+f;d.position.top=e.top-f}else{if(/^(sw)$/.test(h)){d.size.width=i.width+j;d.size.height=
i.height+f}else{d.size.width=i.width+j;d.size.height=i.height+f;d.position.top=e.top-f}d.position.left=e.left-j}}});var b=function(d){return parseInt(d,10)||0},c=function(d){return!isNaN(parseInt(d,10))}})(jQuery);
...
i.dialogClass).css({zIndex:i.zIndex}).attr("tabIndex",-1).css("outline",0).keydown(function(n){if(i.closeOnEscape&&!n.isDefaultPrevented()&&n.keyCode&&n.keyCode===a.ui.keyCode.ESCAPE){g.close(n);n.preventDefault()}}).attr({role:"dialog","aria-labelledby":h}).mousedown(function(n){g.moveToTop(false,n)});g.element.show().removeAttr("title").addClass("ui-dialog-content ui-widget-content").appendTo(j);var k=(g.uiDialogTitlebar=a("<div></div>")).addClass("ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix").prependTo(j),
...
h).html(e).prependTo(k);if(a.isFunction(i.beforeclose)&&!a.isFunction(i.beforeClose))i.beforeClose=i.beforeclose;k.find("*").add(k).disableSelection();i.draggable&&a.fn.draggable&&g._makeDraggable();i.resizable&&a.fn.resizable&&g._makeResizable();g._createButtons(i.buttons);g._isOpen=false;a.fn.bgiframe&&j.bgiframe()},_init:function(){this.options.autoOpen&&this.open()},destroy:function(){this.overlay&&this.overlay.destroy();this.uiDialog.hide();this.element.unbind(".dialog").removeData("dialog").removeClass("ui-dialog-content ui-widget-content").hide().appendTo("body");
...
i.uiDialog[0]){h=a(this).css("z-index");isNaN(h)||(e=Math.max(e,h))}});a.ui.dialog.maxZ=e}return i}},isOpen:function(){return this._isOpen},moveToTop:function(g,i){var e=this.options;if(e.modal&&!g||!e.stack&&!e.modal)return this._trigger("focus",i);if(e.zIndex>a.ui.dialog.maxZ)a.ui.dialog.maxZ=e.zIndex;if(this.overlay){a.ui.dialog.maxZ+=1;this.overlay.$el.css("z-index",a.ui.dialog.overlay.maxZ=a.ui.dialog.maxZ)}g={scrollTop:this.element.scrollTop(),scrollLeft:this.element.scrollLeft()};a.ui.dialog.maxZ+=
...
e.removeClass("ui-dialog-disabled");break;case "draggable":var h=e.is(":data(draggable)");h&&!i&&e.draggable("destroy");!h&&i&&this._makeDraggable();break;case "position":this._position(i);break;case "resizable":(h=e.is(":data(resizable)"))&&!i&&e.resizable("destroy");h&&typeof i==="string"&&e.resizable("option","handles",i);!h&&i!==false&&this._makeResizable(i);break;case "title":a(".ui-dialog-title",this.uiDialogTitlebar).html(""+(i||"&#160;"));break}a.Widget.prototype._setOption.apply(this,arguments)},
_size:function(){var g=this.options,i,e,h=this.uiDialog.is(":visible");this.element.show().css({width:"auto",minHeight:0,height:0});if(g.minWidth>g.width)g.width=g.minWidth;i=this.uiDialog.css({height:"auto",width:g.width}).height();e=Math.max(0,g.minHeight-i);if(g.height==="auto")if(a.support.minHeight)this.element.css({minHeight:e,height:"auto"});else{this.uiDialog.show();g=this.element.css("height","auto").height();h||this.uiDialog.hide();this.element.height(Math.max(g,e))}else this.element.height(Math.max(g.height-
i,0));this.uiDialog.is(":data(resizable)")&&this.uiDialog.resizable("option","minHeight",this._minHeight())}});a.extend(a.ui.dialog,{version:"1.8.17",uuid:0,maxZ:0,getTitleId:function(g){g=g.attr("id");if(!g){this.uuid+=1;g=this.uuid}return"ui-dialog-title-"+g},overlay:function(g){this.$el=a.ui.dialog.overlay.create(g)}});a.extend(a.ui.dialog.overlay,{instances:[],oldInstances:[],maxZ:0,events:a.map("focus,mousedown,mouseup,keydown,keypress,click".split(","),function(g){return g+".dialog-overlay"}).join(" "),
create:function(g){if(this.instances.length===0){setTimeout(function(){a.ui.dialog.overlay.instances.length&&a(document).bind(a.ui.dialog.overlay.events,function(e){if(a(e.target).zIndex()<a.ui.dialog.overlay.maxZ)return false})},1);a(document).bind("keydown.dialog-overlay",function(e){if(g.options.closeOnEscape&&!e.isDefaultPrevented()&&e.keyCode&&e.keyCode===a.ui.keyCode.ESCAPE){g.close(e);e.preventDefault()}});a(window).bind("resize.dialog-overlay",a.ui.dialog.overlay.resize)}var i=(this.oldInstances.pop()||
a("<div></div>").addClass("ui-widget-overlay")).appendTo(document.body).css({width:this.width(),height:this.height()});a.fn.bgiframe&&i.bgiframe();this.instances.push(i);return i},destroy:function(g){var i=a.inArray(g,this.instances);i!=-1&&this.oldInstances.push(this.instances.splice(i,1)[0]);this.instances.length===0&&a([document,window]).unbind(".dialog-overlay");g.remove();var e=0;a.each(this.instances,function(){e=Math.max(e,this.css("z-index"))});this.maxZ=e},height:function(){var g,i;if(a.browser.msie&&
...
i;if(e&&i.charAt(0)==="_")return j;e?this.each(function(){var k=a.data(this,f),l=k&&a.isFunction(k[i])?k[i].apply(k,h):k;if(l!==k&&l!==b){j=l;return false}}):this.each(function(){var k=a.data(this,f);k?k.option(i||{})._init():a.data(this,f,new g(i,this))});return j}};a.Widget=function(f,g){arguments.length&&this._createWidget(f,g)};a.Widget.prototype={widgetName:"widget",widgetEventPrefix:"",options:{disabled:false},_createWidget:function(f,g){a.data(g,this.widgetName,this);this.element=a(g);this.options=
a.extend(true,{},this.options,this._getCreateOptions(),f);var i=this;this.element.bind("remove."+this.widgetName,function(){i.destroy()});this._create();this._trigger("create");this._init()},_getCreateOptions:function(){return a.metadata&&a.metadata.get(this.element[0])[this.widgetName]},_create:function(){},_init:function(){},destroy:function(){this.element.unbind("."+this.widgetName).removeData(this.widgetName);this.widget().unbind("."+this.widgetName).removeAttr("aria-disabled").removeClass(this.widgetBaseClass+
"-disabled ui-state-disabled")},widget:function(){return this.element},option:function(f,g){var i=f;if(arguments.length===0)return a.extend({},this.options);if(typeof f==="string"){if(g===b)return this.options[f];i={};i[f]=g}this._setOptions(i);return this},_setOptions:function(f){var g=this;a.each(f,function(i,e){g._setOption(i,e)});return this},_setOption:function(f,g){this.options[f]=g;if(f==="disabled")this.widget()[g?"addClass":"removeClass"](this.widgetBaseClass+"-disabled ui-state-disabled").attr("aria-disabled",
g);return this},enable:function(){return this._setOption("disabled",false)},disable:function(){return this._setOption("disabled",true)},_trigger:function(f,g,i){var e,h=this.options[f];i=i||{};g=a.Event(g);g.type=(f===this.widgetEventPrefix?f:this.widgetEventPrefix+f).toLowerCase();g.target=this.element[0];if(f=g.originalEvent)for(e in f)e in g||(g[e]=f[e]);this.element.trigger(g,i);return!(a.isFunction(h)&&h.call(this.element[0],g,i)===false||g.isDefaultPrevented())}}})(jQuery);
...
!(this.scrollParent[0]!=document&&a.ui.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,f=/(html|body)/i.test(d[0].tagName),g=b.pageX,i=b.pageY;if(this.originalPosition){var e;if(this.containment){if(this.relative_container){e=this.relative_container.offset();e=[this.containment[0]+e.left,this.containment[1]+e.top,this.containment[2]+e.left,this.containment[3]+e.top]}else e=this.containment;if(b.pageX-this.offset.click.left<e[0])g=e[0]+this.offset.click.left;
if(b.pageY-this.offset.click.top<e[1])i=e[1]+this.offset.click.top;if(b.pageX-this.offset.click.left>e[2])g=e[2]+this.offset.click.left;if(b.pageY-this.offset.click.top>e[3])i=e[3]+this.offset.click.top}if(c.grid){i=c.grid[1]?this.originalPageY+Math.round((i-this.originalPageY)/c.grid[1])*c.grid[1]:this.originalPageY;i=e?!(i-this.offset.click.top<e[1]||i-this.offset.click.top>e[3])?i:!(i-this.offset.click.top<e[1])?i-c.grid[1]:i+c.grid[1]:i;g=c.grid[0]?this.originalPageX+Math.round((g-this.originalPageX)/
c.grid[0])*c.grid[0]:this.originalPageX;g=e?!(g-this.offset.click.left<e[0]||g-this.offset.click.left>e[2])?g:!(g-this.offset.click.left<e[0])?g-c.grid[0]:g+c.grid[0]:g}}return{top:i-this.offset.click.top-this.offset.relative.top-this.offset.parent.top+(a.browser.safari&&a.browser.version<526&&this.cssPosition=="fixed"?0:this.cssPosition=="fixed"?-this.scrollParent.scrollTop():f?0:d.scrollTop()),left:g-this.offset.click.left-this.offset.relative.left-this.offset.parent.left+(a.browser.safari&&a.browser.version<
...
this;setTimeout(function(){a(i).focus();g&&g.call(i)},f)}):this._focus.apply(this,arguments)},scrollParent:function(){var f;f=a.browser.msie&&/(static|relative)/.test(this.css("position"))||/absolute/.test(this.css("position"))?this.parents().filter(function(){return/(relative|absolute|fixed)/.test(a.curCSS(this,"position",1))&&/(auto|scroll)/.test(a.curCSS(this,"overflow",1)+a.curCSS(this,"overflow-y",1)+a.curCSS(this,"overflow-x",1))}).eq(0):this.parents().filter(function(){return/(auto|scroll)/.test(a.curCSS(this,
...
"mousedown")+".ui-disableSelection",function(f){f.preventDefault()})},enableSelection:function(){return this.unbind(".ui-disableSelection")}});a.each(["Width","Height"],function(f,g){function i(k,l,n,s){a.each(e,function(){l-=parseFloat(a.curCSS(k,"padding"+this,true))||0;if(n)l-=parseFloat(a.curCSS(k,"border"+this+"Width",true))||0;if(s)l-=parseFloat(a.curCSS(k,"margin"+this,true))||0});return l}var e=g==="Width"?["Left","Right"]:["Top","Bottom"],h=g.toLowerCase(),j={innerWidth:a.fn.innerWidth,innerHeight:a.fn.innerHeight,
outerWidth:a.fn.outerWidth,outerHeight:a.fn.outerHeight};a.fn["inner"+g]=function(k){if(k===b)return j["inner"+g].call(this);return this.each(function(){a(this).css(h,i(this,k)+"px")})};a.fn["outer"+g]=function(k,l){if(typeof k!=="number")return j["outer"+g].call(this,k);return this.each(function(){a(this).css(h,i(this,k,true,l)+"px")})}});a.extend(a.expr[":"],{data:function(f,g,i){return!!a.data(f,i[3])},focusable:function(f){return c(f,!isNaN(a.attr(f,"tabindex")))},tabbable:function(f){var g=a.attr(f,
"tabindex"),i=isNaN(g);return(i||g>=0)&&c(f,!i)}});a(function(){var f=document.body,g=f.appendChild(g=document.createElement("div"));a.extend(g.style,{minHeight:"100px",height:"auto",padding:0,borderWidth:0});a.support.minHeight=g.offsetHeight===100;a.support.selectstart="onselectstart"in g;f.removeChild(g).style.display="none"});a.extend(a.ui,{plugin:{add:function(f,g,i){f=a.ui[f].prototype;for(var e in i){f.plugins[e]=f.plugins[e]||[];f.plugins[e].push([g,i[e]])}},call:function(f,g,i){if((g=f.plugins[g])&&
f.element[0].parentNode)for(var e=0;e<g.length;e++)f.options[g[e][0]]&&g[e][1].apply(f.element,i)}},contains:function(f,g){return document.compareDocumentPosition?f.compareDocumentPosition(g)&16:f!==g&&f.contains(g)},hasScroll:function(f,g){if(a(f).css("overflow")==="hidden")return false;g=g&&g==="left"?"scrollLeft":"scrollTop";var i=false;if(f[g]>0)return true;f[g]=1;i=f[g]>0;f[g]=0;return i},isOverAxis:function(f,g,i){return f>g&&f<g+i},isOver:function(f,g,i,e,h,j){return a.ui.isOverAxis(f,i,h)&&
a.ui.isOverAxis(g,e,j)}})}})(jQuery);
...
!c){var i=false;a(this.options.handle,f).find("*").andSelf().each(function(){if(this==b.target)i=true});if(!i)return false}this.currentItem=f;this._removeCurrentsFromItems();return true},_mouseStart:function(b,c,d){c=this.options;this.currentContainer=this;this.refreshPositions();this.helper=this._createHelper(b);this._cacheHelperProportions();this._cacheMargins();this.scrollParent=this.helper.scrollParent();this.offset=this.currentItem.offset();this.offset={top:this.offset.top-this.margins.top,left:this.offset.left-
...
"undefined")return false;var b="l"+(this.options.maxListLimit||"n");if(typeof this._localCache[this.options.dictionary][b]==="undefined")return false;for(var c=0;a.length>1||c<10;){a=a.substr(0,a.length-1);var d=this._localCache[this.options.dictionary][b][a];if(d)if(d.isCompleteList){this._lastFoundMatch=a;return true}else break;c++}return false},_cloneMatchObject:function(a){var b={};b.matchedText=a.matchedText.toString();b.matches=a.matches?a.matches.slice():[];b.isCompleteList=a.isCompleteList===
...
-1)this.turnOff(true);else if(jQuery.trim(a).indexOf("NSuggest_CreateData")!==-1){this._addGlobalListener("NSuggest_CreateData_new");eval(a.replace("NSuggest_CreateData","NSuggest_CreateData_new"))}else this._hideOptions()},_localCache:{},_putInCache:function(a,b){if(!this.options.disableCache){var c="l"+(this.options.maxListLimit||"n");this._localCache[this.options.dictionary]||(this._localCache[this.options.dictionary]={});this._localCache[this.options.dictionary][c]||(this._localCache[this.options.dictionary][c]=
{});this._localCache[this.options.dictionary][c][b||this._lastEnteredTerm]||(this._localCache[this.options.dictionary][c][b||this._lastEnteredTerm]=a)}},_setActivedescendant:function(){var a=this.element.attr("id");if(!a){a=jQuery.ui.jig._generateId("ncbiautocomplete");this.element.attr("id",a)}jQuery(this._gol.optionsBox).find("ul:eq(0)").attr("aria-activedescendant",a)},_displayOptions:function(a){this._setActivedescendant();this._putInCache(a);var b=a.matchedText,c=a.matches||[];if(b!==this._lastEnteredTerm){a.isCompleteList=
...
(function(){(function(a){jQuery.widget("ui.ncbibuttonset",jQuery.ui.buttonset,{_create:function(){a(".jig-ncbibuttonset").find("label").addClass("ui-ncbibutton").removeClass("ui-button ui-widget")},destroy:function(){a(".jig-ncbibuttonset").find("label").removeClass("ui-ncbibutton")}})})(jQuery)})();
...
var f=this.element.find("> tbody").length>1,g=0;if(f&&a>0)g=b.filter(":lt("+a+")").filter(":has(th)").length;var i="";if(d<c)i+=":lt("+(d+g)+")";if(a>0)i+=":gt("+(a-1+g)+")";c=b;if(i.length>0){b.not(".ui-ncbigrid-rowHidden").addClass("ui-ncbigrid-rowHidden");c=b.filter(i)}c.removeClass("ui-ncbigrid-rowHidden");if(f){a=c.filter(":has(th)").length;if(a>0){b=0;for(c=c.last().next();b<a&&c.length===1;){if(!c.hasClass("ncbigrid-row-filtered")){c.has("th")||b++;c.removeClass("ui-ncbigrid-rowHidden")}c=
...
this.element.trigger("rowsAdded");q||this._notifyGridUpdated()},_cachedRows:{},getCacheKey:function(){var o=this.getCurrentPage().toString(),q=this.options.pageSize.toString(),m=this.options.sortColumn.toString(),p=this.options.sortColumnDir.toString();o=o+"_"+q+"_"+m+"_"+p;m=this.options.webserviceParams;q="";if(typeof m==="string")q+="_"+m;else for(var u in m)q+="_"+m[u];if(u=this.options.webserviceFilterParams)for(var x in u)q+="_"+u[x];return o+q},addToCache:function(o,q){if(this.options.isServersidePagingCached)this._cachedRows[q||
this.getCacheKey()]=o},isInCache:function(o){return this._cachedRows[o||this.getCacheKey()]||null},_sort:function(){this._wasSorted=true;f.apply(this,arguments)},sortDefaults:function(){this.options.isServersideSort||c.apply(this,arguments)},_killActiveSort:function(){this.options.isServersideSort||d.apply(this,arguments)},_waitForCache:function(){this.options.isServersideSort?this._updateRows():i.apply(this,arguments)},_indexGrid:function(){},filterRows:function(o,q,m){if(this.options.isServersideLoad&&
!this.options.isServersidePaging)e.apply(this,arguments);else{this.options.webserviceFilterParams={};this.options.webserviceFilterParams.filterText=o||"";if(q!=null)this.options.webserviceFilterParams.filterCaseInsen=q;if(m!=null)this.options.webserviceFilterParams.filterCol=m;this.options.isServersidePaging?this.gotoPage(0):this._updateRows();this.element.trigger("ncbigridfilterapplied",[o,q,m,null,null]).trigger("ncbiservergridfilterapplied",[o,q,m,null,null])}},removeFilterRows:function(){if(this.options.isServersideLoad&&
!this.options.isServersidePaging)h.apply(this,arguments);else{this.options.webserviceFilterParams={};this.options.isServersidePaging?this.gotoPage(0):this._updateRows()}this.element.trigger("ncbigridfilterremoved",[null,null,null]).trigger("ncbiservergridfilterremoved",[null,null,null])},refresh:function(o,q){this._checkAllState=!!q;if(this.options.isServersidePagingCached)this._cachedRows={};if(this.options.isServersidePaging){q=this.options.currentPage;if(!o){q=0;this.options.currentPage=-1;this.element.find("tbody").children().find("input[type='checkbox']").prop("checked",
this._checkAllState)}this.gotoPage(q)}else this._updateRows();this.options.checkboxToolbarEnabled&&this._updateCount()},_cachedPageCheckHelper:function(o,q){if(q){q=o?"addClass":"removeClass";for(var m=this.getCacheKey()||"",p=m.replace(/^\d+/,""),u=this.getMaxPage(),x=1;x<=u;x++){var w=x+p,y=this.isInCache(w);if(w===m)y=this.element.find("tbody tr");if(y){y=jQuery(y);y.find(":checkbox").prop("checked",o).closest("tr")[q]("ui-ncbigrid-row-selected");this.addToCache(y,w)}}}},checkAll:function(o){this._cachedPageCheckHelper(true,
o);r.apply(this,arguments)},uncheckAll:function(o){this._cachedPageCheckHelper(false,o);v.apply(this,arguments)},_updateCount:function(){if(this.options.isServersidePagingCached){var o=0,q="filter";if(this._checkAllState){o=this.getRowCount();q="not"}for(var m=0,p=this.getCacheKey()||"",u=p.replace(/^\d+/,""),x=this.getMaxPage(),w=1;w<=x;w++){var y=w+u,C=this.isInCache(y);if(y===p)C=this.element.find("tbody tr");if(C){y=jQuery(C).find(":checkbox")[q](":checked").length||0;m+=y}}o=this._checkAllState?
o-m:m;this._chekboxBars.find("span.ui-ncbigrid-selected-text").html(o)}else n.apply(this,arguments)},_gotoPage:function(){var o=this.options.isServersidePagingCached;o&&this._prevCacheKey&&this.options.currentPage!==-1&&this.addToCache(this.element.find("tbody tr"),this._prevCacheKey);s.apply(this,arguments);if(o)this._prevCacheKey=this.getCacheKey()},_cbSerialize:function(o){var q=[];o.each(function(){q.push(this.name+"="+(this.checked?"on":"off"))});return q.join("&")},serializeCachedCheckboxes:function(o){var q=
null;if(this.options.isServersidePagingCached){q=[];for(var m=this.getCacheKey()||"",p=m.replace(/^\d+/,""),u=this.getMaxPage(),x=1;x<=u;x++){var w=x+p,y=this.isInCache(w);if(w===m)y=this.element.find("tbody tr");if(y)(w=o===undefined?this._cbSerialize(jQuery(y).find(":checkbox")):o?jQuery(y).find(":checkbox").serialize():this._cbSerialize(jQuery(y).find(":checkbox").not(":checked")))&&w.length>0&&q.push(w)}q=q.join("&")}return q},_setPageInit:function(){this.element.trigger("resetScroll");var o=
this._getCurrentPage(),q=this.getMaxPage();this._showHidePageToolbar();this._updateButtons(o,q);this._updatePagingText(o,q);this._updateGoto(o,q);this._updateItemRange(o,q);this._pageBars.find(".ui-ncbigrid-paged-pageControl").attr({"aria-valuemin":"1","aria-controls":this.element.attr("id"),"aria-valuemax":q,"aria-valuenow":o})}})})();
...
"&nbsp;");if(Math.abs(f.height()+g-d.height())>3){h=f.height()+g;if(h>=e)b(e,"auto");else h<=i?b(i,"hidden"):b(h,"hidden")}}}var d=this.element;if(d.attr("type")!="textarea"&&d.get(0).nodeName.toLowerCase()!="textarea")return false;this.elastic_uid=a.ui.jig._generateId("ncbielastictextarea");d.css("word-wrap","break-word");var f=a("<div />").css({position:"absolute",display:"none","word-wrap":"break-word"}).attr("id",this.elastic_uid),g=parseInt(d.css("line-height"),10)||parseInt(d.css("font-size"),
"10"),i=parseInt(d.css("height"),10)||g*3,e=parseInt(d.css("max-height"),10)||Number.MAX_VALUE;if(e<0)e=Number.MAX_VALUE;f.appendTo(d.parent());a(this.styles.copy).each(function(){f.css(this.toString(),d.css(this.toString()))});a(window).bind("resize."+this.elastic_uid,function(){f.css("width",d.width()+"px");c("force")});d.css({overflow:"hidden"});f.css("width",d.width()+"px");d.bind("keyup."+this.elastic_uid,function(){c()});d.bind("input."+this.elastic_uid+" paste."+this.elastic_uid,function(){setTimeout(c,
...
var d=this.options.openMethod||this.options.openEvent,f=this.options.closeMethod||this.options.closeEvent;if(d===f&&f==="click"){this._openFunction=function(g){a._toggle(g,g.currentTarget);g.preventDefault()};b.on("click",this._openFunction)}else{c={timeout:this.options.delayTimeout};if(d==="mouseover")c.over=function(g){a._isOverTrigger=true;a.open(g,this)};else{c.over=function(){a._isOverTrigger=true};this._openFunction=function(g){if(d==="click")if(a.option.isTriggerElementCloseClick){a._toggle(g,
this);g.preventDefault()}else{a.isOpen(this)||g.preventDefault();a.open(g,this)}else a.open(g,this)};b.on(d,this._openFunction)}if(f==="mouseout")c.out=function(){a._isOverTrigger=false;a.isOpen(this)&&!a._isOverPopper&&a.close()};else{c.out=function(){};this._closeFunction=function(g){a.close();f==="click"&&g.preventDefault()};b.on(f,this._closeFunction)}if(d==="mouseover"||f==="mouseout")b.hoverIntent(c);if(this.options.isTriggerElementCloseClick&&f!=="click"&&d!=="click"){this._closeFunction2=
function(g){a.isOpen(b)&&a.close();g.preventDefault()};b.on("click",this._closeFunction2)}}if(this.options.isDestElementCloseClick){this._closeFunctionPopper=function(g){a.isOpen(b)&&a.close();g.preventDefault()};this.getDestElement().on("click",this._closeFunctionPopper)}},_removeEventHandlers:function(){var a=this.element,b=this.getDestElement(),c=this.options.multipleHandlesSelector;if(c&&c.length>0)a=a.add(c);a.off("mouseover mouseout");if(this._openFunction){a.off(this.options.openMethod||this.options.openEvent,
...
this.getDestElement(),b=Math.floor(a.position().top),c=Math.floor(a.position().left),d=Math.floor(c+a.outerWidth());a=Math.floor(b+a.height());var f=this._arrow,g=Math.floor(f.position().top),i=Math.floor(f.position().left);Math.floor(i+f.width());var e=Math.floor(g+f.height());c=i>c&&i<d||i+f.css("width")>c&&i+f.css("width")<d;b=g>b&&g<a||g+f.css("height")>b&&e+f.css("height")<a;return c&&b?true:false},_openAnimation:function(a){function b(){var l=d.outerHeight(),n=jQuery(window).height();l>n&&d.css({"max-height":n-
45+"px",overflow:"auto"});jQuery(window).trigger("resize")}var c=this,d=this.getDestElement().data("isOpening",this.element).stop(true,true),f=this._arrow,g=this.options.openAnimation,i=function(){c._trigger("opencomplete");c.getDestElement().data("isOpening",null);jQuery.browser.msie&&parseInt(jQuery.browser.version,10)<=7&&c._positionPopper(a,false,true);b()},e=function(l){f.fadeTo(0,0);window.setTimeout(function(){f.stop(true,true).show();c._arrowOverlapsPopper()||f.css("opacity",1)},l)};if(g===
"none"||this.isOpen()){d.show();f&&e(0);i()}else{var h=this.options.openAnimationTime;if(f){var j=0;if(f==="top")j=0;else if(f==="bottom")j=h;else{j=parseInt(f.css("top"),10)-parseInt(d.css("top"),10);var k=d.height()||j;j=j/k*h;if(j>h)j=h}e(j)}d[g](h,i)}},open:function(a,b){if(!b)b=this.element;if(this.options.openAtTarget){if(this._activeTrigger!==b){this.getDestElement().hide();this.getDestElement().data("isOpen",false)}this._activeTrigger=b}else this._activeTrigger=this.element;b=this.getDestElement();
...
iconArrowStop:"ui-icon-arrowthickstop-1-s",iconArrowStopOpen:"ui-icon-arrowthickstop-1-n"},options:{animation:"slide",closedAppendText:"",cookieNamePrefix:"jig-tog-rem-",indicator:"small-arrow",initOpen:false,isIcon:true,liveRegions:true,openedAppendText:"",remember:false,speed:50,accessibilityFallback:true,targets:""},_cachedTargetData:{},_create:function(){this._setOption("disabled",false);this.appendTextNode=this.initTargetsClass=this.iconSpan=this.startOpen=this.rememberCookie=this.remember=this.cookieName=
this.addedHref=null;var b=this.element,c=b[0],d=this.styles,f=this,g=this.options.isIcon;b.addClass("ui-widget ui-ncbitoggler");g||b.addClass("ui-ncbitoggler-no-icon");var i=b.attr("href");!i?(this.addedHref=true):(this.addedHref=false);this._validate(i);b.children("span.ui-ncbitoggler-master-text").length===0&&b.contents().filter(function(){return this.nodeType===3}).each(function(){var e=a(this);jQuery.trim(this.nodeValue).length>0&&e.wrap('<span class="ui-ncbitoggler-master-text"></span>')});if(this.options.openedAppendText!==
""||this.options.closedAppendText!==""){this.appendTextNode=b.children("span.ui-ncbitoggler-appended-text");if(this.appendTextNode.length===0)if(!this.initOpen){this.appendTextNode=a('<span class="ui-ncbitoggler-appended-text">'+this.options.closedAppendText+"</span>");b.find(".ui-ncbitoggler-master-text").after(this.appendTextNode)}}if(this.remember=this.options.remember||false){i=this.element.attr("id");if(!i){window.console&&console.error&&console.error("ncbitoggler: master node "+c+" must have a unique id attribute when remembering state");
return}this.cookieName=this.options.cookieNamePrefix+i;this.rememberCookie=a.cookie(this.cookieName)}if(this.startOpen=this.rememberCookie?this.rememberCookie==="open"?true:false:b.hasClass("jig-ncbitoggler-open")||b.hasClass(d.masterOpen)||this.options.initOpen?true:false){b.removeClass(this.styles.master);b.addClass(d.masterOpen);this._targetsOpen=true}else{b.removeClass(this.styles.masterOpen);b.addClass(d.master)}g&&this._initMasterIcon();this.targets=this._getTargets();this.targets.addClass("ui-ncbitoggler").removeClass("ui-ncbitoggler-disabled ui-state-disabled");
if(this.startOpen){this.targets.removeClass(d.target);this.targets.addClass(d.targetOpen);this.initTargetsClass=d.targetOpen}else{this.targets.removeClass(d.targetOpen);this.targets.addClass(d.target);this.initTargetsClass=d.target}this._initAria();this._doGrouping();b.click(function(e){f.toggle(e,f)});this._saveReferences()},_getGroupMaster:function(){for(var b=this.styles,c=this.element[0].className.split(/\s+/),d=0;d<c.length;d++){var f=c[d].match(/ui-ncbitoggler-group-(.+)$/);if(f){f=f[1];var g=
a("a.ui-ncbitoggler-group-open-"+f+", a.ui-ncbitoggler-group-close-"+f,this.options.contextNode);if(g.length===1){g.hasClass("ui-ncbitoggler-group-open-"+f)&&g.addClass(b.groupMasterStateOpen);g.hasClass("ui-ncbitoggler-group-close-"+f)&&g.addClass(b.groupMasterStateClose);return g}}}},_doGrouping:function(){var b=this._getGroupMaster();if(b){var c=this,d=this.styles,f=b.data("togglers");this.element.id||a.ui.jig._generateId(this.widgetName);if(!this.element[0].id)this.element[0].id=a.ui.jig._generateId(this.widgetName);
if(typeof f==="undefined"){b.data("togglers",[]);b.data("togglers").push(this.element)}else f.push(this.element);var g=b.find(d.groupMasterReplaceNode);b.click(function(i){i.preventDefault();i=b.data("togglers");i=i[i.length-1][0];if(b.hasClass(d.groupMasterStateOpen)){c.open();g.length>0&&g.text(c.options.groupMasterCloseReplaceText);c.element[0]===i&&b.removeClass(d.groupMasterStateOpen).addClass(d.groupMasterStateClose)}else{c.close();g.length>0&&g.text(c.options.groupMasterOpenReplaceText);c.element[0]===
i&&b.removeClass(d.groupMasterStateClose).addClass(d.groupMasterStateOpen)}})}},_initAria:function(){var b=this.startOpen;this.element.attr({role:"button","aria-expanded":b});this.options.liveRegions&&this.targets.each(function(){var c=a(this);c.find("table").length===0&&!c.parent("div").hasClass("ui-helper-reset")&&c.wrap('<div class="ui-helper-reset" aria-live="assertive">');c.attr("aria-hidden",b?"false":"true")})},_validate:function(b){var c=this.element,d=["a"],f=c[0].tagName.toLowerCase();if(a.inArray(f,
d)===-1)throw new Error("ncbitoggler: master node must be one of the following elements: "+d.toString());b||c.attr("href","#")},_initMasterIcon:function(){var b=this.element,c=this.styles;if(this.options.indicator=="plus-minus-big"){this.iconOpenClass=c.iconPlusMinusBigOpen;this.iconCloseClass=c.iconPlusMinusBig}else if(this.options.indicator=="arrow-stop"){this.iconOpenClass=c.iconArrowStopOpen;this.iconCloseClass=c.iconArrowStop}else{this.iconOpenClass=c.iconOpen;this.iconCloseClass=c.icon}this.iconSpan=
b.find("span.ui-icon");if(this.iconSpan.length===0){this.iconSpan=a('<span class="ui-icon"></span>');this.startOpen?this.iconSpan.addClass(this.iconOpenClass):this.iconSpan.addClass(this.iconCloseClass);b.append(this.iconSpan)}else if(this.startOpen){this.iconSpan.removeClass(this.iconCloseClass);this.iconSpan.addClass(this.iconOpenClass)}},getSlaves:function(){return this._targets},getTargets:function(){return this.getSlaves()},_getTargets:function(){var b=this.element,c=b.attr("toggles")||b.attr("data-ncbitoggler-toggles");
if(c)jQuery.ui.jig._isConsole("warn")&&console.warn('The attributes "toggles" and "data-ncbitoggler-toggles" are deprecated. Please use the "targets" attribute instead (see documentation).');else c=this.options.targets;if(c&&typeof c=="object"){c=c;b="";for(var d in c)b+=d+", ";b=b.replace(/,\s$/,"");d=a(b)}else if(c){d=a(c);if(d.length===0){this.isSibling=false;d=c.split(/ +/);c="";for(b=0;b<d.length;b++)c+=b!==d.length-1?"#"+d[b]+",":"#"+d[b];d=a(c)}}else if(b.parent(":header").length>0){b.parent(":header").parent().css("zoom",
"1");this.isSibling=true;d=b.parent(":header").css("zoom","1").next()}else{this.isSibling=true;d=b.next()}return this._targets=this._normalizeTargets(d)},_normalizeTargets:function(b){var c=[];b.each(function(){var d=this,f=a(this);if(f.hasClass("ui-helper-reset"))d=f.children().get(0);c.push(d)});return ret=a(c)},_getCachedTargetData:function(b){return this._cachedTargetData[b]},_cacheTargetData:function(b,c){this._cachedTargetData[b]=c},_openAjaxTarget:function(b,c){var d=this,f=this._getCachedTargetData(b);
f?a(b).html(f):a.get(c,function(g){d._cacheTargetData(b,g);a(b).html(g)})},_openTargets:function(){if(!(this._targetsOpening||this._targetsClosing||this._targetOpen)){this._targetsOpening=true;var b=this.targets,c=this.styles;b.removeClass(c.target).addClass(c.targetOpen).attr("aria-hidden","false");var d=this.options.targets;if(typeof d=="object"){var f=this;for(targetSel in d)(function(g){f._openAjaxTarget(g,d[g])})(targetSel)}c=this.options.openedAppendText;c!==""&&this.appendTextNode.html(c);
b.css("display","");this._targetsOpening=false;this._targetsOpen=true}},_closeTargets:function(){if(!(this._targetsOpening||this._targetsClosing||!this._targetsOpen)){this._targetsClosing=true;var b=this.targets,c=this.styles;b.removeClass(c.targetOpen).addClass(c.target).attr("aria-hidden","true");c=this.options.closedAppendText;c!==""&&this.appendTextNode.html(c);b.css("display","");this._targetsOpen=this._targetsClosing=false}},_fixHasLayout:function(b){window.setTimeout(function(){b.targets.addClass("foo").removeClass("foo")},
1)},open:function(b){var c=this.element,d=this;if(!c.hasClass(this.styles.master))return c;this.updateState("open");if(this.options.animation==="slide")this.targets.slideToggle(this.options.speed,function(){d._openTargets();a.browser.msie&&d._fixHasLayout(d);c.trigger("ncbitoggleropen");b&&b()});else{this._openTargets();a.browser.msie&&d._fixHasLayout(d);c.trigger("ncbitoggleropen");b&&b()}this._updateReferences("open");return c},close:function(b){var c=this.element,d=this;if(!c.hasClass(this.styles.masterOpen))return c;
this.updateState("closed");if(this.options.animation==="slide")this.targets.slideToggle(this.options.speed,function(){d._closeTargets();c.trigger("ncbitogglerclosed").trigger("ncbitogglerclose");b&&b()});else{this._closeTargets();c.trigger("ncbitogglerclosed");b&&b()}this._updateReferences("closed");return c},toggle:function(b,c,d){var f=arguments.length;if(f===0||f===1){c=this;if(f===1)d=arguments[0]}else b.preventDefault();this.element.hasClass(this.styles.master)?c.open(d):c.close(d)},updateState:function(b){var c=
this.element;b||(b=c.hasClass(styles.master)?"open":"closed");var d=this.styles.master,f=this.styles.masterOpen,g=this.iconCloseClass,i=this.iconOpenClass;if(b=="closed"){d=this.styles.masterOpen;f=this.styles.master;g=this.iconOpenClass;i=this.iconCloseClass}c.removeClass(d).addClass(f).attr("aria-expanded",b=="closed"?"false":"true");this.options.isIcon&&this.iconSpan.removeClass(g).addClass(i);this.remember&&a.cookie(this.cookieName,b)},_removeHandlers:function(){this.element.unbind("click")},
destroy:function(){a.Widget.prototype.destroy.apply(this,arguments);var b=this.element,c=this.styles;b.removeClass(c.master+" "+c.masterOpen+" ui-state-disabled ui-widget ui-ncbitoggler-disabled").removeAttr("role").removeAttr("aria-expanded");this.targets.removeClass("ui-ncbitoggler ui-ncbitoggler-slave ui-ncbitoggler-slave-open ui-state-disabled ui-ncbitoggler-disabled");this.targets.removeAttr("aria-hidden");if(this.options.isIcon){c=b.find("span.ui-icon")[0];b[0].removeChild(c)}this.targets.each(function(){var f=
jQuery(this),g=f.parent("div.ui-helper-reset");if(g.length>0){f.insertBefore(g);g.remove()}});c=b.find("span.ui-ncbitoggler-master-text");var d=c.html();c.remove();b.html(d);this._removeHandlers();return this},disable:function(){a.Widget.prototype.disable.apply(this,arguments);this._removeHandlers();this.targets.addClass("ui-ncbitoggler-disabled ui-state-disabled");return this},enable:function(){a.Widget.prototype.enable.apply(this,arguments);this.targets.removeClass("ui-ncbitoggler-disabled ui-state-disabled");
var b=this;this.element.click(function(c){b.toggle(c,b)});return this},_saveReferences:function(){var b=this;this._targets.each(function(){typeof a(this).data("ncbitoggler-masters")==="undefined"&&a(this).data("ncbitoggler-masters",[]);a(this).data("ncbitoggler-masters").push(b.element)})},_updateReferences:function(b){var c=this;a.each(this._targets.data("ncbitoggler-masters"),function(){c.element!=this&&a(this).ncbitoggler("updateState",b)})}})})(jQuery);
...
c._trigger("expand",i)}).bind("collapse.treeEvents",function(i){c._collapse(i.target);c._trigger("collapse",i)}).bind("toggle.treeEvents",function(i){c._toggle(i.target)}).bind("traverseDown.treeEvents",function(i){var e=a(i.target);e.length||(e=b.find("a[tabindex=0]"));e.length||(e=a(i.target));i=e.closest("li");if(i.is("[aria-expanded=true]"))i.find("ul[role=group]").find("a").eq(0).focus();else i.next().length?i.next().find("a").eq(0).focus():i.parents("li").next().find("a").eq(0).focus()}).bind("traverseUp.treeEvents",
function(i){var e=a(i.target);e.length||(e=b.find("a[tabindex=0]"));e.length||(e=a(i.target));i=e.closest("li");if(i.prev().length)i.prev().is("[aria-expanded=true]")?i.prev().find("li:visible:last a").eq(0).focus():i.prev().find("a").eq(0).focus();else i.parents("li:eq(0)").find("a").eq(0).focus()});b.bind("focus.treeEvents",function(i){b.find("[tabindex=0]").attr("tabindex","-1").removeClass("ui-state-focus");a(i.target).attr("tabindex","0").addClass("ui-state-focus")}).bind("click.treeEvents",
...
40&&e.trigger("traverseDown");return false}else if((i.keyCode==13||i.keyCode==32)&&e.closest("li").is("li[role=treeitem]")){e.closest("span.tree-parent").trigger("toggle");return false}});var g=b.attr("id");if(g&&a.cookie("ncbitree")&&a.parseJSON(a.cookie("ncbitree"))[g]){d=a.parseJSON(a.cookie("ncbitree"))[g];c._load_state(d)}else b.find(d.expanded).find(">span").each(function(){c._expand(this)})}b.find("li[role=treeitem] > a, li[role=treeitem] > span").filter(function(){return jQuery(this).data("treeid")!==
f}).addClass("ui-state-default").data("treeid",f).bind("mouseenter.treeEvents",function(){a(this).addClass("ui-state-hover")}).bind("mouseleave.treeEvents",function(){a(this).removeClass("ui-state-hover")})},_expand:function(b){var c=this.options,d=this,f=this.list,g=b?a(b):f.find("a[tabindex=0]");g.addClass("ui-state-active").removeClass("ui-state-default");g.siblings("ul").hide().removeClass("tree-group-collapsed").slideDown(c.speed,function(){a(this).removeAttr("style");g.parent().attr("aria-expanded",
"true").addClass("tree-expanded");c.remember&&d._save_state()})},_collapse:function(b){var c=this.options,d=this,f=this.list,g=b?a(b):f.find("a[tabindex=0]");g.removeClass("ui-state-active").addClass("ui-state-default");g.siblings("ul").slideUp(c.speed,function(){g.parent().attr("aria-expanded","false").removeClass("tree-expanded");a(this).addClass("tree-group-collapsed").removeAttr("style");c.remember&&d._save_state()})},_toggle:function(b){var c=this.list;b=b?a(b):c.find("a[tabindex=0]");b.parent().is("[aria-expanded=false]")?
...
(function(){jQuery.widget("ui.ncbilinksmenu",jQuery.ui.ncbipopper,{options:{openEvent:"click",closeEvent:"click",closeOnSelect:true,openAnimation:"none",cssClass:"ui-ncbilinksmenu",ignoreSettingOutterWidth:true,excludeBasicCssStyles:true,wrapElement:true,preventDefault:""},_create:function(){this._checkHrefForWebService();this._setPopperOptions();jQuery.ui.ncbipopper.prototype._create.apply(this,arguments);this._addMenuAria();this._addOpenEvents()},destroy:function(){this._destroyMenuAria();this._destroyMenu();
this._destroyOpenEvents();jQuery.ui.ncbipopper.prototype.destroy.apply(this,arguments)},_checkHrefForWebService:function(){if(!this.options.webservice&&!this.options.destSelector&&!this.options.localJSON)this.options.webservice=this.element.attr("href")},_setPopperOptions:function(){var a=this.options;if(a.loadingMessage)a.showLoadingMessage=true;if(!a.width)a.width="200px";if(this.options.webservice||this.options.localJSON)this.options.destText="<ul class='linksmenu-ul'><li class='ui-ncbilinksmenu-loadingMessage'><span>"+
...
if(!a.hasClass("ui-ncbibasicmenu")){a.ncbibasicmenu({stopPropagationCheck:false,normalizeSubsToOneLevel:true,disableSelect:true});var b=this,c=function(d){var f=a.closest(".ui-ncbilinksmenu").data("attachedTo"),g=jQuery.ui.jig.getElementWidgets(f,"ncbilinksmenu")[0];g||(g=b);if(g.isOpen()){d.type!="ncbibasicmenuescape"&&g.options.closeOnSelect&&g.close();a.not(jQuery(d.target)).find("li.selected").not(jQuery(d.target).closest("li")).removeClass("selected");d.type!="ncbibasicmenuescape"&&g.options.closeOnSelect&&
f.focus()}};this._selectedFnc=c;a.on("ncbibasicmenuescape",c);a.on("click","a",c)}},_destroyMenu:function(){var a=this.getDestElement().find("ul").eq(0);a.ncbibasicmenu("destroy");a.ncbibasicmenu("focus").off("ncbibasicmenuescape",this._selectedFnc).off("ncbibasicmenuenter",this._selectedFnc).off("click",this._selectedFnc);this._selectedFnc=null},_loadContentJSON:function(a){function b(g,i){var e=g.text,h=g.href||"#",j=g.target||"",k=g.click||"";typeof k=="string"&&k!=""&&eval("click = "+k);var l=
g.rel||"";if(j)j=' target="'+j+'"';if(l)l=' rel="'+l+'"';g=jQuery("<li></li>");e=jQuery("<a href='"+h+"'"+j+l+">"+e+"</a>");if(k)try{e.click(function(s){k.call(this,s,d);s.preventDefault&&jQuery(this).is(d.options.preventDefault)&&s.preventDefault()})}catch(n){typeof console!=="undefined"&&console.error&&console.error(n)}g.append(e);i.append(g)}function c(g,i){for(var e=0;e<g.length;e++){var h=g[e],j=h.heading;if(j){var k=jQuery("<li></li>").attr("role","heading");j=jQuery("<span>"+j+"</span>");k.append(j);
if(h=h.links){j=jQuery("<ul></ul>");c(h,j);k.append(j)}i.append(k)}else b(h,i)}}typeof a==="function"&&a.apply(this);var d=this,f=jQuery("<ul></ul>");(a=a.links)&&c(a,f);this._contentFetched=true;this.isFunctionResultCached=this.options.isDestTextCacheable;this.getDestElement().empty().append(f);this._createMenu();this._trigger("jsonmenuloaded")},_logError:function(){if(typeof ncbi!=="undefined"&&ncbi.sg&&ncbi.sg.ping){var a={jsevent:"ncbilinksmenu_error"},b=this.element,c=b.attr("id")||null,d=b.attr("href")||
null;b=b.text()||null;var f=this.options.webservice;if(c)a.id=c;if(d)a.href=d;if(b)a.text=b;if(f)a.webservice=f;ncbi.sg.ping(a)}},_setTriggerId:function(){var a=this.element.attr("id");a&&this.getDestElement().data("triggerId","#"+a).attr("data-jigtriggerid","#"+a).data("trigger",this.element)},_pingDetails:function(a,b,c){typeof ncbi!=="undefined"&&ncbi.sg&&ncbi.sg.ping&&ncbi.sg.ping(b,a.originalEvent,c,{})},_addOpenEvents:function(){var a=this;this._keyDownFnc=function(b){b=b.keyCode;if(b===38||
b===40)a.open()};this.element.on("keydown",this._keyDownFnc)},_destroyOpenEvents:function(){this.element.off("keydown",this._keyDownFnc);this._keyDownFnc=null}})})();
...
this;this.element.bind("keyup change",function(){a._showIfValue()}).bind("paste",function(){window.setTimeout(function(){a._showIfValue()},10)})},_pingData:function(){typeof ncbi!=="undefined"&&ncbi.sg&&ncbi.sg.ping({jsevent:"ncbiclearbutton",prevValue:this.element.val()})},_attachButtonEvents:function(){var a=this;this.clearButton.click(function(b){a.clearText();a._hideButton();a.element.focus();b.preventDefault()})}});
jQuery.widget("ui.ncbiplaceholder",{options:{},_label:null,_create:function(){if(!jQuery.ui.ncbiplaceholder.hasPlaceholderSupport()){var a=this.element.attr("type");a=="hidden"||a=="button"||a=="submit"||a=="radio"||a=="checkbox"||a=="image"||a=="reset"||this._fakeLabel()}},destroy:function(){this._removeFakeLabel()},_fakeLabel:function(){var a=this,b=this.element.offset(),c=this.element.outerWidth(),d=this.element.outerHeight(),f=parseInt(this.element.css("borderTopWidth"),0),g=parseInt(this.element.css("borderLeftWidth"),
0),i=this.element.attr("placeholder").replace(/<br\s?\/?>/,"");this._label=jQuery('<label class="ui-ncbiplaceholder-label" aria-hidden="true">'+i+"</label>").insertAfter(this.element).css({left:b.left+g,top:b.top+f,width:c,height:d});jQuery(["paddingTop","paddingRight","paddingBottom","paddingLeft","fontSize","lineHeight","fontFamily","width","fontWeight"]).each(function(){a._label.css(this.toString(),a.element.css(this.toString()))});this.element.val().length!==0&&this._label.hide();this._label.on("click",
function(){a.element.focus()});this.element.on("focus.ncbiplaceholder",function(){a._label.hide()});this.element.on("blur.ncbiplaceholder",function(){a.element.val().length===0&&a._label.show()})},_removeFakeLabel:function(){this._label.remove();this.element.off("blur.ncbiplaceholder");this.element.off("focus.ncbiplaceholder")},value:function(){return this.element.val()},hasValue:function(){return this.element.val().length!==0}});
jQuery.ui.ncbiplaceholder.hasPlaceholderSupport=function(){var a=document.createElement("input"),b="placeholder"in a;a=null;jQuery.ui.ncbiplaceholder.hasPlaceholderSupport=function(){return b};return b};
jQuery.widget("ui.ncbiexpander",{options:{openDelay:200,delayTimeout:400,animationSpeed:200,minHeight:"55px",accessibilityFallback:function(a){var b=a[0].tagName.toLowerCase();if(b==="li"){var c=a.parent("ul");if(c.siblings("a.ui-helper-hidden-accessible").length===0)return c}if(b==="div")return a},accessibilityFallbackCustomDestroy:function(a){a[0].tagName.toLowerCase()==="ul"?a.find("li.jig-ncbiexpander").each(function(){$this=jQuery(this);$this.find("div.ui-ncbiexpander").length>0&&$this.ncbiexpander("destroy")}):
a.ncbiexpander("destroy")}},_create:function(){this._wrapperInner();this._setHeightAndClass();if(this.isExpanable){this._addArrow();this._setArrowDirection("closed");this._hookUpEvents()}},destroy:function(){var a=this.element,b=a.find("div.ui-ncbiexpander"),c=b.html();b.remove();a.html(c);a.find("ui-expander-arrow-bar").remove()},_wrapperInner:function(){this._wrapper=this.element.wrapInner("<div class='expanderWrapper'></div>").find(".expanderWrapper")},_setHeightAndClass:function(){this._wrapper.addClass("ui-ncbiexpander").height(this.options.minHeight);
(this.isExpanable=this._wrapper[0].scrollHeight>this._wrapper.height())||this._wrapper.addClass("ui-ncbiexpander-simple").height("auto")},_hookUpEvents:function(){var a=this;if(this.isExpanable){this.element.hoverIntent({interval:this.options.openDelay,timeout:this.options.delayTimeout,over:function(){a._isOpen=true;var b=a._wrapper[0].scrollHeight;a._wrapper.stop().animate({height:b},a.options.animationSpeed,function(){a._setArrowDirection("open")})},out:function(){a._isOpen=false;a._wrapper.stop().animate({height:a.options.minHeight},
...
"#");this.blur();this.focus();return false});b.click(function(c){var d=jQuery(this).data("selindex");a._selectOptionClick(d,c);c.preventDefault()})},_selectOptionClick:function(a,b){if(this.isMultiple){var c=b.shiftKey;if(b.ctrlKey||b.metaKey){this.previousShift=undefined;if(this.element.find("option").eq(a).prop("selected")){this.unselectOption(a);return}}else if(c){if(this.activeOption!==-1){if(this.previousShift!==undefined){this.activeOption=this.previousShift;this._removePreviousSelection()}else this.previousShift=
...
0?0:Math.ceil(d*Math.log(p)/Math.log(o)):Math.ceil(d*p/o);if(p>0&&u<3)u=3;var x=d-u;p=c(p.toString());var w=' title="'+h.replace(/\{label\}/gi,m).replace(/\{count\}/gi,p)+'"';v.push('<li><a href="#"'+w+(' style="height:'+u+"px;margin-top:"+x+'px"')+(' data-label="'+m+'"')+(' data-count="'+p+'"')+(g===m?' class="selected"':"")+">Year "+m+" - "+p+" items</a></li>")},v=[],o=j[0].count;jQuery.map(j,function(m){if(o<m.count)o=m.count});var q=null;jQuery.map(j,function(m,p){p=j[p];m=p.textlabel;p=p.count;
if(i){l(q,m,p);q=m}else r(m,p)});a=' class="not-nested"';if(i){s();a=""}return'<ol style="width:'+e*(this.options.barWidth+this.options.barSpacing)+'px" '+a+">"+v.join("")+"</ol>"},_makeArrows:function(){var a=this;this._controlBar=jQuery('<div class="ui-ncbihistogram-controls"></div>');this._arrow_right=jQuery("<div></div>").addClass("ui-ncbihistogram-right").html("Scroll right...").appendTo(this._controlBar).click(function(){a.moveRight()});this._arrow_left=jQuery("<div></div>").addClass("ui-ncbihistogram-left").html("Scroll left...").appendTo(this._controlBar).click(function(){a.moveLeft()});
...
h.addClass("ui-state-hover");h.hasClass("ui-datepicker-prev")&&h.addClass("ui-datepicker-prev-hover");h.hasClass("ui-datepicker-next")&&h.addClass("ui-datepicker-next-hover")}})}function f(e,h){a.extend(e,h);for(var j in h)if(h[j]==null||h[j]==b)e[j]=h[j];return e}a.extend(a.ui,{datepicker:{version:"1.8.17"}});var g=(new Date).getTime(),i;a.extend(c.prototype,{markerClassName:"hasDatepicker",maxRows:4,log:function(){this.debug&&console.log.apply("",arguments)},_widgetDatepicker:function(){return this.dpDiv},
...
true;a.effects&&a.effects[j]?h.dpDiv.show(j,a.datepicker._get(h,"showOptions"),l,n):h.dpDiv[j||"show"](j?l:null,n);if(!j||!l)n();h.input.is(":visible")&&!h.input.is(":disabled")&&h.input.focus();a.datepicker._curInst=h}}}},_updateDatepicker:function(e){this.maxRows=4;var h=a.datepicker._getBorders(e.dpDiv);i=e;e.dpDiv.empty().append(this._generateHTML(e));var j=e.dpDiv.find("iframe.ui-datepicker-cover");j.length&&j.css({left:-h[0],top:-h[1],width:e.dpDiv.outerWidth(),height:e.dpDiv.outerHeight()});
...
N.getTime()&&r==e.selectedMonth&&e._keyEvent||M.getTime()==z.getTime()&&M.getTime()==N.getTime()?" "+this._dayOverClass:"")+(Q?" "+this._unselectableClass+" ui-state-disabled":"")+(I&&!E?"":" "+P[1]+(z.getTime()==q.getTime()?" "+this._currentClass:"")+(z.getTime()==h.getTime()?" ui-datepicker-today":""))+'"'+((!I||E)&&P[2]?' title="'+P[2]+'"':"")+(Q?"":' onclick="DP_jQuery_'+g+".datepicker._selectDay('#"+e.id+"',"+z.getMonth()+","+z.getFullYear()+', this);return false;"')+">"+(I&&!E?"&#xa0;":Q?'<span class="ui-state-default">'+
z.getDate()+"</span>":'<a class="ui-state-default'+(z.getTime()==h.getTime()?" ui-state-highlight":"")+(z.getTime()==q.getTime()?" ui-state-active":"")+(I?" ui-priority-secondary":"")+'" href="#">'+z.getDate()+"</a>")+"</td>";z.setDate(z.getDate()+1);z=this._daylightSavingAdjust(z)}F+=T+"</tr>"}r++;if(r>11){r=0;u++}F+="</tbody></table>"+(o?"</div>"+(s[0]>0&&K==s[1]-1?'<div class="ui-datepicker-row-break"></div>':""):"");S+=F}G+=S}G+=k+(a.browser.msie&&parseInt(a.browser.version,10)<7&&!e.inline?'<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>':
"");e._keyEvent=false;return G},_generateMonthYearHeader:function(e,h,j,k,l,n,s,r){var v=this._get(e,"changeMonth"),o=this._get(e,"changeYear"),q=this._get(e,"showMonthAfterYear"),m='<div class="ui-datepicker-title">',p="";if(n||!v)p+='<span class="ui-datepicker-month">'+s[h]+"</span>";else{s=k&&k.getFullYear()==j;var u=l&&l.getFullYear()==j;p+='<select class="ui-datepicker-month" onchange="DP_jQuery_'+g+".datepicker._selectMonthYear('#"+e.id+"', this, 'M');\" >";for(var x=0;x<12;x++)if((!s||x>=k.getMonth())&&
(!u||x<=l.getMonth()))p+='<option value="'+x+'"'+(x==h?' selected="selected"':"")+">"+r[x]+"</option>";p+="</select>"}q||(m+=p+(n||!(v&&o)?"&#xa0;":""));if(!e.yearshtml){e.yearshtml="";if(n||!o)m+='<span class="ui-datepicker-year">'+j+"</span>";else{r=this._get(e,"yearRange").split(":");var w=(new Date).getFullYear();s=function(y){y=y.match(/c[+-].*/)?j+parseInt(y.substring(1),10):y.match(/[+-].*/)?w+parseInt(y,10):parseInt(y,10);return isNaN(y)?w:y};h=s(r[0]);r=Math.max(h,s(r[1]||""));h=k?Math.max(h,
k.getFullYear()):h;r=l?Math.min(r,l.getFullYear()):r;for(e.yearshtml+='<select class="ui-datepicker-year" onchange="DP_jQuery_'+g+".datepicker._selectMonthYear('#"+e.id+"', this, 'Y');\" >";h<=r;h++)e.yearshtml+='<option value="'+h+'"'+(h==j?' selected="selected"':"")+">"+h+"</option>";e.yearshtml+="</select>";m+=e.yearshtml;e.yearshtml=null}}m+=this._get(e,"yearSuffix");if(q)m+=(n||!(v&&o)?"&#xa0;":"")+p;m+="</div>";return m},_adjustInstDate:function(e,h,j){var k=e.drawYear+(j=="Y"?h:0),l=e.drawMonth+
...
"string"?a.datepicker["_"+e+"Datepicker"].apply(a.datepicker,[this].concat(h)):a.datepicker._attachDatepicker(this,e)})};a.datepicker=new c;a.datepicker.initialized=false;a.datepicker.uuid=(new Date).getTime();a.datepicker.version="1.8.17";window["DP_jQuery_"+g]=a})(jQuery);
...
n);break}b._slide(e,j,l);return h}}).keyup(function(e){var h=a(this).data("index.ui-slider-handle");if(b._keySliding){b._keySliding=false;b._stop(e,h);b._change(e,h);a(this).removeClass("ui-state-active")}});this._refreshValue();this._animateOff=false},destroy:function(){this.handles.remove();this.range.remove();this.element.removeClass("ui-slider ui-slider-horizontal ui-slider-vertical ui-slider-disabled ui-widget ui-widget-content ui-corner-all").removeData("slider").unbind(".slider");this._mouseDestroy();
return this},_mouseCapture:function(b){var c=this.options,d,f,g,i,e;if(c.disabled)return false;this.elementSize={width:this.element.outerWidth(),height:this.element.outerHeight()};this.elementOffset=this.element.offset();d=this._normValueFromMouse({x:b.pageX,y:b.pageY});f=this._valueMax()-this._valueMin()+1;i=this;this.handles.each(function(h){var j=Math.abs(d-i.values(h));if(f>j){f=j;g=a(this);e=h}});if(c.range===true&&this.values(1)===c.min){e+=1;g=a(this.handles[e])}if(this._start(b,e)===false)return false;
this._mouseSliding=true;i._handleIndex=e;g.addClass("ui-state-active").focus();c=g.offset();this._clickOffset=!a(b.target).parents().andSelf().is(".ui-slider-handle")?{left:0,top:0}:{left:b.pageX-c.left-g.width()/2,top:b.pageY-c.top-g.height()/2-(parseInt(g.css("borderTopWidth"),10)||0)-(parseInt(g.css("borderBottomWidth"),10)||0)+(parseInt(g.css("marginTop"),10)||0)};this.handles.hasClass("ui-state-hover")||this._slide(b,e,d);return this._animateOff=true},_mouseStart:function(){return true},_mouseDrag:function(b){var c=
...
this.options.range,c=this.options,d=this,f=!this._animateOff?c.animate:false,g,i={},e,h,j,k;if(this.options.values&&this.options.values.length)this.handles.each(function(l){g=(d.values(l)-d._valueMin())/(d._valueMax()-d._valueMin())*100;i[d.orientation==="horizontal"?"left":"bottom"]=g+"%";a(this).stop(1,1)[f?"animate":"css"](i,c.animate);if(d.options.range===true)if(d.orientation==="horizontal"){if(l===0)d.range.stop(1,1)[f?"animate":"css"]({left:g+"%"},c.animate);if(l===1)d.range[f?"animate":"css"]({width:g-
